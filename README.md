...
- [Introduction](#introduction)
  * [Testing Checkout Credentials](#testing-checkout-credentials)
- [UX](#ux)
...
- [Design](#design)
  ...
  * [Product List Layout Considerations](#product-list-layout-considerations)
...
- [Features](#features)
  * [Implemented Features.](#implemented-features)
    ...
    + [Product Admin](#product-admin)
      ...
      - [Delete Product Button](#delete-product-button)
    + [Footer](#footer)
    + [Edit Comment Page](#edit-comment-page)
    + [Site Features for Non-registered](#site-features-for-non-registered)
    + [Home page](#home-page)
    + [Search Bar](#search-bar-1)
    + [Nav Bar Drop Downs](#nav-bar-drop-downs)
    + [My Account](#my-account)
    + [Basket Layer](#basket-layer-1)
    + [Basket Page](#basket-page-1)
    + [Checkout Page](#checkout-page-1)
    + [Order Confirmation Page](#order-confirmation-page)
    + [Order confirmation layer](#order-confirmation-layer)
    + [Blogs Page](#blogs-page)
    + [Blogs Detail Page](#blogs-detail-page)
    + [Add Comment Page](#add-comment-page)
  * [Features to Improve/Implement](#features-to-improve-implement)
    + [1. Interactive Videos of the Items](#1-interactive-videos-of-the-items)
    + [2. Weekly Newsletter](#2-weekly-newsletter)
    + [3. Item Recommendations](#3-item-recommendations)
    + [4. Website Theme Swaps](#4-website-theme-swaps)
    + [5. Site Review Score](#5-site-review-score)
    + [6. Order Confirmation Email](#6-order-confirmation-email)
    + [7. Comment Workflow](#7-comment-workflow)
    + [8. Delete Comments](#8-delete-comments)
    + [9. Product Reviews & Ratings](#9-product-reviews---ratings)
    + [10. Enhanced Blog](#10-enhanced-blog)
    + [11. Updated Blogger Profile](#11-updated-blogger-profile)
...
- [Technologies and Tools](#technologies-and-tools)
  * [Data Infrastructure](#data-infrastructure)
    ...
    + [Data Models](#data-models)
      ...
      - [CHECKOUT_ORDERLINEITEM](#checkout-orderlineitem)
