"""
Django settings for get_booted project.
...
ALLOWED_HOSTS = ['tomod24-get-booted.herokuapp.com', 'localhost']
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'getbooted@example.com'
else:
